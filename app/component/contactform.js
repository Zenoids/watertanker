export default function ContactForm({ar=false}){
  ...
  <h2 className="mb-8 text-center text-2xl font-bold text-gray-800 md:mb-12 lg:text-3xl py-10">Where to find us?</h2>
...
/>
      ...
      <div className="bg-gray-800 relative flex  flex-col  flex-wrap py-6 rounded shadow-md w-full " >
        ...
        <div className="lg:w-full px-6 text-white mt-4 lg:mt-0 ">
          ...
          <h4 className="leading-relaxed text-center">+966 0509201569 | +966 0597424796</h4>
        </div>
      </div>
    </div>
 ...
 <section className="text-gray-600 body-font relative bg-white ">
 <h2 className="mb-8 text-center text-2xl font-bold text-gray-800 md:mb-12 lg:text-3xl py-10">أين تجدنا؟
</h2>
 <div className="container px-5  mx-auto flex sm:flex-nowrap flex-wrap  " style={{height:"80vh"}}> 
   <div className="lg:w-full  bg-white rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative ">
...
/>
     ...
     <div className="bg-gray-800 relative flex  flex-col flex-wrap py-6 rounded shadow-md w-full " >
       <div className="lg:w-full px-6">
         <h3 className="font-bold text-center  text-white tracking-widest text-xl">
         عنوان
       ...
       <div className="lg:w-full px-6 text-white mt-4 lg:mt-0">
         ...
         <h3 className="title-font text-center font-semibold text-white tracking-widest text-xl mt-4">
         الاتصال 
         </h3>
         <h4 className="leading-relaxed text-center">۹٦٦ ۰٥۰۹۲۰۱٥٦۹|+۹٦٦ ۰٥۹۷٤۲٤۷۹٦</h4>
       </div>
     </div>
   </div>
