...
export const metadata = {
    ...
    description:" Sweet Water Supply Riyadh  استكشف خدمات المياه الشاملة التي نقدمها في وايت ماء شمال الرياض والتي تلبي احتياجات العملاء السكنية والتجارية. نوفر الوصول المستمر إلى مياه عالية الجودة من خلال حلولنا الموثوقة في التوصيل والصيانة"
