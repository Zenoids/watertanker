...
export const metadata = {
    ...
    description:"Sweet Water Supply Riyadh  تعرف على وايت ماء شمال الرياض، المزود الرائد لتوصيل المياه النظيفة والآمنة. اكتشف التزامنا الثابت بالجودة والموثوقية ورضا العملاء"
