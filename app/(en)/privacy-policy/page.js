...
export default function Privacy() {
  return (
    <>
    <h1>Privacy Policy for Sweet Water Supply</h1>
    <p>
      At Sweet Water Supply, accessible from Sweet Water Supply, one of our main
      priorities is the privacy of our visitors. This Privacy Policy document
      contains types of information that is collected and recorded by Sweet Water
      Supply and how we use it.
    </p>
    <p>
    ...
    <p>
      ...
      and/or collect in Sweet Water Supply. This policy is not applicable to any
    ...
    <h2>Log Files</h2>
    <p>
      Sweet Water Supply follows a standard procedure of using log files. These
    ...
    <p>
      ...
      advertising partners of Sweet Water Supply.
    </p>
    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective advertisements
      and links that appear on Sweet Water Supply, which are sent directly to
    ...
    <p>
      Note that Sweet Water Supply has no access to or control over these cookies
      that are used by third-party advertisers.
    </p>
    <h2>Third Party Privacy Policies</h2>
    <p>
      Sweet Water Supply's Privacy Policy does not apply to other advertisers or
    ...
    <p>
      Sweet Water Supply does not knowingly collect any Personal Identifiable
