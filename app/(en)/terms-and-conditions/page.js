...
export const metadata = {
  title: ' وايت ماء شمال الرياض Terms and conditions | Sweet water supply | Riyadh ',
  description: ' وايت ماء شمال الرياض',
}
export default function Tc() {
  return (
    <>
  <h1>Terms and Conditions for Sweet Water Supply</h1>
  <h2>Introduction</h2>
  <p>
    These Website Standard Terms and Conditions written on this webpage shall
    manage your use of our website, Sweet Water Supply accessible at
    www.SweetWaterSupply.
  </p>
  <p>
  ...
  <p>
    Other than the content you own, under these Terms, Sweet Water Supply and/or
  ...
  <p>
    ...
    Sweet Water Supply may further restrict access by you to any areas of this
  ...
  <p>
    In no event shall Sweet Water Supply, nor any of its officers, directors and
    ...
    contract. &nbsp;Sweet Water Supply, including its officers, directors and
  ...
  <p>
    You hereby indemnify to the fullest extent Sweet Water Supply from and
  ...
  <p>
    Sweet Water Supply is permitted to revise these Terms at any time as it sees
    fit, and by using this Website you are expected to review these Terms on a
    regular basis.
  </p>
  <h2>Assignment</h2>
  <p>
    The Sweet Water Supply is allowed to assign, transfer, and subcontract its
  ...
  <p>
    These Terms constitute the entire agreement between Sweet Water Supply and
  ...
  <p>
    ...
    of the State of sa, and you submit to the non-exclusive jurisdiction of the
    state and federal courts located in sa for the resolution of any disputes.
  </p>
</>
